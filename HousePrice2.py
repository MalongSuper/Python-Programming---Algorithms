...
print("Case 2: Only Area, Bedrooms")
scaler = MinMaxScaler(feature_range=(0, 1))
# Apply scaling to the 'area', 'bedrooms' column
...
X_train = train_df[['area_scaled', 'bedrooms_scaled']]  # Using multiple scaled features
y_train = train_df['price']  # Target variable is 'price'
X_test = test_df[['area_scaled', 'bedrooms_scaled']]  # Using multiple scaled features
...
# The Linear Equation is Y = A + BX -> Y: Price, X1: area_scaled,
# X2: bedrooms_scaled in this case
A = model.intercept_
